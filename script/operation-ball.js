...
(function () {
  ...
  function createBallElement(ballRadius) {
    ...
    ball.style.right = isMobile?'20px':'40px';
    ball.style.bottom = isMobile?'60px':'80px';
    return ball;
  }
  ...
  function signCallback(signStr) {
    const hash = window.CryptoJSTest.HmacSHA1(signStr, config.secretKey);
